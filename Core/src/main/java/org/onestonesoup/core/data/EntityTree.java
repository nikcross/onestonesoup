...
public class EntityTree {
	...
	public class TreeEntity {
		...
		private TreeEntity(TreeEntity parent, String name) {
		...
		public TreeEntity addChild(String name) {
			TreeEntity node = new TreeEntity(this,name);
			children.add(node);
			return node;
		}
		...
		private void setParent(TreeEntity parent) {
			this.parent = parent;
		}
